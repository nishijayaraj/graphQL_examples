...
In grahiql editor test following

mutation {
createStudent(collegeId: "col-2", firstName: "Tim", lastName: "George", email :"tim.george@tutorialpoint.org", password :"pass123")
}
